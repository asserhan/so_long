...
/*   Updated: 2022/12/28 17:30:07 by hasserao         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int	loop_hook(t_game *game)
{
	...
	if (game->sprite == 1)
		game->enemy_img = mlx_xpm_file_to_image(game->mlx,"bonus/img/enemy1.xpm",&game->img_width,&game->img_height);
	if(game->sprite == 2)
	{
		game->enemy_img = mlx_xpm_file_to_image(game->mlx,"bonus/img/enemy2.xpm",&game->img_width,&game->img_height);
	}
	if(game->sprite == 3)
	{
